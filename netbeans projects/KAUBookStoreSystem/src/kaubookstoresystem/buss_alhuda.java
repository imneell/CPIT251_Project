...
import static cpit251_project.buss_alkha.marketing;
 ...
 * @author manar
 */
public class buss_alhuda extends javax.swing.JFrame {
...
static Book book4;
    /**
     * Creates new form buss_alhuda
     */
    public buss_alhuda() throws FileNotFoundException {
        initComponents();
    ...
    String info1 [] = read.next().split(",");
        ...
        break;
              case "402" :  String info2 [] = read.next().split(",");
         marketing1 = new Picture ("marketing1.jpg");
        if(book.isAvailable(info2[5])==true){
            avamarketing1=true;
        ...
        bl.addBook(book3);         jLabel10.setText(book3.getPrice()+"");
         break;
            case "403" :  String info3 [] = read.next().split(",");
...
bi.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buss_alhuda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new buss_alhuda().setVisible(true);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(buss_alhuda.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
