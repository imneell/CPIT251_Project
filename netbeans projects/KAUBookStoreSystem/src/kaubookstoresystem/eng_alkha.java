...
import static cpit251_project.fcit_alhuda.network;
 ...
 * @author manar
 */
public class eng_alkha extends javax.swing.JFrame {
static Picture hwdesign;
static Picture machine;
static Picture comeng;

//to check availablity of book
static boolean avahwdesign;
static boolean avacomeng;
static boolean avamachine;
//books
static Book book1;
static Book book2;
static Book book3;
    /**
     * Creates new form eng_alkha
     */
    public eng_alkha() throws FileNotFoundException {
        initComponents();
    ...
    String info1 [] = read.next().split(",");
         hwdesign = new Picture ("hwdesign.jpg");
        ...
        if(book.isAvailable(info1[7])==true){
         ...
         book1 = new Book(bookName1,info1[3],info1[4],ava,info1[5],hwdesign);
           jhwdesign.setIcon(new ImageIcon(hwdesign.getImage().getScaledInstance(160, 160, 1)));
        bl.addBook(book1);
        break;
              case "41" :  String info2 [] = read.next().split(",");
         machine = new Picture ("machine.jpg");
        ...
        book2 = new Book(bookName2,info2[3],info2[4],avamachine,info2[5],machine);
           jmachine.setIcon(new ImageIcon(machine.getImage().getScaledInstance(160, 160, 1)));
        bl.addBook(book2);
         break;
            case "42" :  String info3 [] = read.next().split(",");
         comeng = new Picture ("comeng.jpg");
        ...
        if(book.isAvailable(info3[7])==true){
         ...
         book3 = new Book(bookName3,info3[3],info3[4],ava,info3[5],comeng);
           jcomeng.setIcon(new ImageIcon(comeng.getImage().getScaledInstance(160, 160, 1)));
        bl.addBook(book3);break;
          }}
    }
    ...
    private void initComponents() {
        ...
        jmachine = new javax.swing.JLabel();
        incmachine = new javax.swing.JButton();
        decarab201 = new javax.swing.JButton();
        arab201_price = new javax.swing.JPanel();
        jLabel8 = new javax.swing.JLabel();
        jcomeng = new javax.swing.JLabel();
        inccomeng = new javax.swing.JButton();
        isls401_price = new javax.swing.JPanel();
        jLabel9 = new javax.swing.JLabel();
        decisls401 = new javax.swing.JButton();
        jhwdesign = new javax.swing.JLabel();
        inchwdesign = new javax.swing.JButton();
        ...
        jmachine.setBackground(new java.awt.Color(102, 102, 255));
        jmachine.setForeground(new java.awt.Color(255, 51, 51));
        jmachine.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jmachineMouseClicked(evt);
            }
        });

        incmachine.setBackground(new java.awt.Color(255, 255, 204));
        incmachine.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        incmachine.setText("+");
        incmachine.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                incmachineMouseClicked(evt);
            }
        });
        incmachine.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                incmachineActionPerformed(evt);
            }
        });
        ...
        jcomeng.setBackground(new java.awt.Color(102, 102, 255));
        jcomeng.setForeground(new java.awt.Color(255, 51, 51));
        jcomeng.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jcomengMouseClicked(evt);
            }
        });

        inccomeng.setBackground(new java.awt.Color(255, 255, 204));
        inccomeng.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        inccomeng.setText("+");
        inccomeng.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                inccomengActionPerformed(evt);
            }
        });
        ...
        jhwdesign.setBackground(new java.awt.Color(102, 102, 255));
        jhwdesign.setForeground(new java.awt.Color(255, 51, 51));
        jhwdesign.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jhwdesignMouseClicked(evt);
            }
        });

        inchwdesign.setBackground(new java.awt.Color(255, 255, 204));
        inchwdesign.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        inchwdesign.setText("+");
        inchwdesign.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                inchwdesignMouseClicked(evt);
            }
        });
        inchwdesign.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                inchwdesignActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(incmachine))
                            .addComponent(jmachine, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(11, 11, 11)
                        .addComponent(jLabel7)
                        .addGap(46, 46, 46)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jhwdesign, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(inccomeng))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(816, 816, 816)
                        .addComponent(jcomeng, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jmachine, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(arab201_price, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(incmachine, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(decarab201, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jcomeng, javax.swing.GroupLayout.DEFAULT_SIZE, 187, Short.MAX_VALUE)
                                    .addComponent(jhwdesign, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(inchwdesign, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    ...
                                    .addComponent(inccomeng, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(131, 131, 131)
                .addComponent(jLabel3))
    ...
    private void incmachineMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_incmachineMouseClicked
...
JOptionPane.showMessageDialog(null,"book is added to cart", "",JOptionPane.INFORMATION_MESSAGE);
    ...
    }//GEN-LAST:event_incmachineMouseClicked

    private void incmachineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_incmachineActionPerformed
...
JOptionPane.showMessageDialog(null,"book is added to cart", "",JOptionPane.INFORMATION_MESSAGE);
    ...
    }//GEN-LAST:event_incmachineActionPerformed

    private void inccomengActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inccomengActionPerformed
...
JOptionPane.showMessageDialog(null,"book is added to cart", "",JOptionPane.INFORMATION_MESSAGE);
    ...
    }//GEN-LAST:event_inccomengActionPerformed

    private void inchwdesignMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_inchwdesignMouseClicked

        if(avahwdesign==false){
            UIManager.put("OptionPane.background", Color.DARK_GRAY);
            UIManager.put("OptionPane.foreground", Color.DARK_GRAY);
            UIManager.put("OptionPane.questionDialog.titlePane.shadow", Color.RED);
            UIManager.put("Panel.background", Color.DARK_GRAY);
...
JOptionPane.showMessageDialog(null,"book is added to cart", "",JOptionPane.INFORMATION_MESSAGE);
    ...
    }//GEN-LAST:event_inchwdesignMouseClicked

    private void inchwdesignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inchwdesignActionPerformed
...
JOptionPane.showMessageDialog(null,"book is added to cart", "",JOptionPane.INFORMATION_MESSAGE);
    ...
    }//GEN-LAST:event_inchwdesignActionPerformed
    ...
    private void jmachineMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jmachineMouseClicked
             try {
...
bi.setVisible(true);
    ...
    }//GEN-LAST:event_jmachineMouseClicked

    private void jhwdesignMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jhwdesignMouseClicked
          try {
         BookInterface bi = new BookInterface();
...
bi.setVisible(true);
    ...
    }//GEN-LAST:event_jhwdesignMouseClicked

    private void jcomengMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jcomengMouseClicked
         try {
         BookInterface bi = new BookInterface();
...
bi.setVisible(true);
    ...
    }//GEN-LAST:event_jcomengMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(eng_alkha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new eng_alkha().setVisible(true);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(eng_alkha.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
    ...
    private javax.swing.JButton inccomeng;
    private javax.swing.JButton inchwdesign;
    private javax.swing.JButton incmachine;
    ...
    private javax.swing.JLabel jcomeng;
    private javax.swing.JLabel jhwdesign;
    private javax.swing.JLabel jmachine;
