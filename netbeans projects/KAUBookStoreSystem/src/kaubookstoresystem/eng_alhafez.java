 ...
 * @author manar
 */
public class eng_alhafez extends javax.swing.JFrame {
...
static Book book3;
    /**
     * Creates new form eng_alhafez
     */
    public eng_alhafez() throws FileNotFoundException {
        initComponents();
    ...
    String info1 [] = read.next().split(",");
        ...
        if(book.isAvailable(info1[7])==true){
         ...
         book1 = new Book(bookName1,info1[3],info1[4],avahwdesign,info1[5],hwdesign);
           jhwdesign.setIcon(new ImageIcon(hwdesign.getImage().getScaledInstance(160, 160, 1)));
        bl.addBook(book1);
        break;
              case "71" :  String info2 [] = read.next().split(",");
        ...
        bl.addBook(book2);
         break;
            case "72" :  String info3 [] = read.next().split(",");
        ...
        if(book.isAvailable(info3[7])==true){
         ...
         book3 = new Book(bookName3,info3[3],info3[4],avacomeng,info3[5],comeng);
...
bi.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(eng_alhafez.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new eng_alhafez().setVisible(true);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(eng_alhafez.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
