 ...
 * @author manar
 */
public class science_alhu extends javax.swing.JFrame {
...
static Book book5;
    /**
     * Creates new form science_alhu
     */
    public science_alhu() throws FileNotFoundException {
        initComponents();
    ...
    String info1 [] = read.next().split(",");
        ...
        bl.addBook(book2);
        break;
              case "302" :  String info2 [] = read.next().split(",");
...
bi.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(science_alhu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new science_alhu().setVisible(true);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(science_alhu.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
