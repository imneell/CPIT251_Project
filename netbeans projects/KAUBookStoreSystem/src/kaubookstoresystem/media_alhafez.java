...
import static cpit251_project.media_alhu.comm1;
 ...
 * @author manar
 */
public class media_alhafez extends javax.swing.JFrame {
...
static Book book5;
    /**
     * Creates new form media_alhafez
     */
    public media_alhafez() throws FileNotFoundException, FileNotFoundException, FileNotFoundException {
        initComponents();
...
String bookName = info[1] + " " + info[2];
    ...
    String info1 [] = read.next().split(",");
        ...
        bl.addBook(book2);
        break;
         case "2001" :  String info2 [] = read.next().split(",");
        ...
        bl.addBook(book3);
         break;
            case "2002" :  String info3 [] = read.next().split(",");
        ...
        bl.addBook(book4);break;
            case "2003" :  String info4 [] = read.next().split(",");
...
bi.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(media_alhafez.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new media_alhafez().setVisible(true);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(media_alhafez.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
