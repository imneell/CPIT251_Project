 ...
 * @author manar
 */
public class eng_alhuda extends javax.swing.JFrame {
...
static Book book3;
    /**
     * Creates new form eng_alhuda
     */
    public eng_alhuda() throws FileNotFoundException {
        initComponents();
...
bi.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(eng_alhuda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new eng_alhuda().setVisible(true);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(eng_alhuda.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
