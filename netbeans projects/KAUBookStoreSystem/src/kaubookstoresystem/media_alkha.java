 ...
 * @author manar
 */
public class media_alkha extends javax.swing.JFrame {
...
static Book book5;
    ...
    /**
     * Creates new form media_alkha
     */
    public media_alkha() throws FileNotFoundException {
        initComponents();
    ...
    String bookName = info[1] + " " + info[2];
        ...
        jcomm1.setIcon(new ImageIcon(comm1.getImage().getScaledInstance(160, 160, 1)));
         book1 = new Book(bookName,info[3],info[4],ava,info[5],comm1);
        bl.addBook(book1);
        break;
              case "18" :
    String info1 [] = read.next().split(",");
        ...
        bl.addBook(book2);
        break;
              case "19" :  String info2 [] = read.next().split(",");
        ...
        bl.addBook(book3);
         break;
            case "21" :  String info3 [] = read.next().split(",");
        ...
        bl.addBook(book4);break;
            case "22" :  String info4 [] = read.next().split(",");
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addComponent(incpolitics1, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(7, 7, 7)
...
bi.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(media_alkha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new media_alkha().setVisible(true);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(media_alkha.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
