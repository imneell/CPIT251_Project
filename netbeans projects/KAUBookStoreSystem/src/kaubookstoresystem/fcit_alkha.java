 ...
 * @author manar
 */
public class fcit_alkha extends javax.swing.JFrame {
...
static Book book5;
    ...
    /**
     * Creates new form fcit_alkha
     */
    public fcit_alkha() throws FileNotFoundException {
        initComponents();
    ...
    String info1 [] = read.next().split(",");
        ...
        bl.addBook(book2);
        break;
              case "8" :  String info2 [] = read.next().split(",");
        ...
        bl.addBook(book3);
         break;
            case "9" :  String info3 [] = read.next().split(",");
        ...
        if(book.isAvailable(info3[7])==true){
         ...
         book4 = new Book(bookName3,info3[3],info3[4],avaskills,info3[5],skills);
           jcomskills.setIcon(new ImageIcon(skills.getImage().getScaledInstance(160, 160, 1)));
        bl.addBook(book4);break;
            case "10" :  String info4 [] = read.next().split(",");
        ...
        Book book5 = new Book(bookName5,info4[4],info4[5],avaarchitecture,info4[6],architecture);
...
bi.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fcit_alkha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new fcit_alkha().setVisible(true);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(fcit_alkha.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
