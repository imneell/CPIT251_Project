 ...
 * @author manar
 */
public class buss_alkha extends javax.swing.JFrame {
...
static Book book4;
    ...
    /**
     * Creates new form buss_alkha
     */
    public buss_alkha() throws FileNotFoundException {
        initComponents();
      ...
      while(read.hasNext()){
        ...
        bl.addBook(book1);         jLabel8.setText(book1.getPrice()+"");
        break;
              case "14" :
    String info1 [] = read.next().split(",");
        ...
        if(book.isAvailable(info1[6])==true){
         ...
         book2 = new Book(info1[1],Integer.parseInt(info1[2]),Integer.parseInt(info1[3]),ava,info1[4],accounting);
           jaccounting.setIcon(new ImageIcon(accounting.getImage().getScaledInstance(160, 160, 1)));
        bl.addBook(book2);         jLabel9.setText(book2.getPrice()+"");
        break;
              case "15" :  String info2 [] = read.next().split(",");
        ...
        if(book.isAvailable(info2[6])==true){
         ...
         book3 = new Book(info2[1],Integer.parseInt(info2[2]),Integer.parseInt(info2[3]),avamarketing1,info2[4],marketing1);
           jmark2.setIcon(new ImageIcon(marketing1.getImage().getScaledInstance(160, 160, 1)));
        bl.addBook(book3);         jLabel10.setText(book3.getPrice()+"");
         break;
            case "16" :  String info3 [] = read.next().split(",");
         admins = new Picture ("adminis.jpeg");
        if(book.isAvailable(info3[5])==true){
            avaadmins=true;
        }else{
            avaadmins=false;
        }
         book4 = new Book(info3[1],Integer.parseInt(info3[2]),Integer.parseInt(info3[3]),avaadmins,info3[4],admins);    
...
bi.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buss_alkha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new buss_alkha().setVisible(true);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(buss_alkha.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
