 ...
 * @author manar
 */
public class generalsub_alhafez extends javax.swing.JFrame {
...
static Book book6;
    /**
     * Creates new form generalsub_alhafez
     */
    public generalsub_alhafez() throws FileNotFoundException {
        initComponents();
    ...
    String info1 [] = read.next().split(",");
        ...
        bl.addBook(book2);
        break;
              case "702" :  String info2 [] = read.next().split(",");
        ...
        bl.addBook(book3);
         break;
            case "703" :  String info3 [] = read.next().split(",");
        ...
        bl.addBook(book4);break;
            case "704" :  String info4 [] = read.next().split(",");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(arab101_price1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGap(1, 1, 1))))
                    .addComponent(isls301_price, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(74, 74, 74)
                .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
...
bi.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(generalsub_alhafez.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new generalsub_alhafez().setVisible(true);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(generalsub_alhafez.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
