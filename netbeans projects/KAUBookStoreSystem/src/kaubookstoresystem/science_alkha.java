...
import static cpit251_project.media_alkha.comm1;
 ...
 * @author manar
 */
public class science_alkha extends javax.swing.JFrame {
...
static Book book5;
    /**
     * Creates new form science_alkha
     */
    public science_alkha() throws FileNotFoundException, IOException {
        initComponents();
    ...
    String info1 [] = read.next().split(",");
        ...
        bl.addBook(book2);
        break;
              case "24" :  String info2 [] = read.next().split(",");
        ...
        bl.addBook(book3);
         break;
            case "25" :  String info3 [] = read.next().split(",");
         chem = new Picture ("chem.jpg");
        if(book.isAvailable(info3[6])==true){
            avachem=true;
        }else{
            avachem=false;
        }
         book4 = new Book(info3[1],Integer.parseInt(info3[2]),Integer.parseInt(info3[3]),avachem,info3[4],chem);
           jchem.setIcon(new ImageIcon(chem.getImage().getScaledInstance(160, 160, 1)));
        bl.addBook(book4);break;
            case "12" :  String info4 [] = read.next().split(",");
         stat = new Picture ("stat.jpeg");
        if(book.isAvailable(info4[6])==true){
            avastat=true;
        }else{
            avastat=false;
        }
         book5 = new Book(info4[1],Integer.parseInt(info4[2]),Integer.parseInt(info4[3]),avastat,info4[4],stat);
           jstat.setIcon(new ImageIcon(stat.getImage().getScaledInstance(160, 160, 1)));
    ...
    private void initComponents() {
        ...
        searcbutton = new javax.swing.JPanel();
        ...
        searcbutton.setBackground(new java.awt.Color(204, 255, 204));
        searcbutton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                searcbuttonMouseClicked(evt);
            }
        });
        ...
        javax.swing.GroupLayout searcbuttonLayout = new javax.swing.GroupLayout(searcbutton);
        searcbutton.setLayout(searcbuttonLayout);
        searcbuttonLayout.setHorizontalGroup(
            searcbuttonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, searcbuttonLayout.createSequentialGroup()
                .addContainerGap(37, Short.MAX_VALUE)
                .addComponent(jLabel5)
                .addGap(33, 33, 33))
        );
        searcbuttonLayout.setVerticalGroup(
            searcbuttonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, searcbuttonLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jLabel5)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(searcbutton, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(24, 24, 24)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(searcbutton, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
...
JOptionPane.showMessageDialog(null,"book is added to cart", "",JOptionPane.INFORMATION_MESSAGE);
    ...
    private void searcbuttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searcbuttonMouseClicked
    ...
    }//GEN-LAST:event_searcbuttonMouseClicked
...
bi.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(science_alkha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new science_alkha().setVisible(true);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(science_alkha.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private javax.swing.JPanel searcbutton;
