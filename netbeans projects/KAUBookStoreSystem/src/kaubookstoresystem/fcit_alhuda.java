 ...
 * @author manar
 */
public class fcit_alhuda extends javax.swing.JFrame {
...
static Book book5;
    /**
     * Creates new form fcit_alhuda
     */
    public fcit_alhuda() throws FileNotFoundException, FileNotFoundException {
        initComponents();
    ...
    String info1 [] = read.next().split(",");
        ...
        bl.addBook(book2);
        break;
              case "202" :  String info2 [] = read.next().split(",");
        ...
        bl.addBook(book3);
         break;
            case "203" :  String info3 [] = read.next().split(",");
        ...
        bl.addBook(book4);break;
            case "204" :  String info4 [] = read.next().split(",");
...
bi.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fcit_alhuda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new fcit_alhuda().setVisible(true);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(fcit_alhuda.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
